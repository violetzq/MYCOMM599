...
# Title
st.title("YouTube Analytics and Content Insights")
...
with tabs[0]:
    ...
    if city_search_term:
        ...
        if not filtered_city_data.empty:
            # Remove the code-like column and keep only necessary columns
...
with tabs[1]:
    ...
    if search_query:
        search_results = data[data['Video title'].str.contains(search_query, case=False
